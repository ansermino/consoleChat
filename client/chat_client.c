...
void display_header(){
	printf("/**                           _        _______ _                 \n");
	printf("*                            | |      (_______) |            _   \n");
	printf("*  ____ ___  ____   ___  ___ | | _____ _      | |__  _____ _| |_ \n");
	printf("* / ___) _ \\|  _ \\ /___)/ _ \\| || ___ | |     |  _ \\(____ (_   _)\n");
	printf("*( (__| |_| | | | |___ | |_| | || ____| |_____| | | / ___ | | |_ \n");
	printf("* \\____)___/|_| |_(___/ \\___/ \\_)_____)\\______)_| |_\\_____|  \\__)\n");
	printf("*\n");
	printf("*/                                                                \n");
}
